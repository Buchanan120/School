...
{
private:
	// Phil says to have this be the number of chars that the user can get to. ['B','o','b',0] has capacity three.
	unsigned int _capacity; // current number of chars allocated
	unsigned int _length; // current length of string
